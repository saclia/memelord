package com.example.memelord.customui;
...
// TODO Remove execessive bloated code
// Figure out which functions actually are needed and to stop the ui from being a 1-time event click

public class BubbleNavigationView extends LinearLayout implements View.OnClickListener, IBubbleNavigation {

    private static final String TAG = BubbleNavigationView.class.getSimpleName();
